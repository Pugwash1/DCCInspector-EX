...
/*
 * TelnetManager class definition - include file.
 * 
 * Encapsulates the WiFI and TelnetServer functionality of the DCC inspector program.
 * 
 * TELNETMANAGER ISN'T SUPPORTED ON NANO, UNO or MEGA because of lack of memory.
 */
...
class TelnetManagerClass {
  public:
    ...
    void getIP();
    // process commands from telnet
    int getCommands();
    // Function to get IP address if connected
    char *getTelnetString() { 
  ...
  private:
    ...
    boolean bufferPointerDirty = false;
    static WiFiServer server;
    static WiFiClient serverClient;
} /* class HttpManagerClass */;

// Singleton class instance.
extern TelnetManagerClass TelnetManager;
